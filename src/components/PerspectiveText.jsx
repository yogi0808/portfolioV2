...
const PerspectiveText = ({ children, classis }) => {
  return (
    <div
      className={`w-full h-full flex items-center justify-center perspective-text transition-transform duration-[0.75s] ease-[cubic-bezier(0.76,0,0,0.24,1)] ${
        classis ? classis : ""
      }`}
    >
